...
class MarketDataCollector:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        exchange_id: str = settings.exchange.name
        ...
        self._exchange: ccxt.Exchange = exchange_cls(
            {
                ...
                "rateLimit": settings.exchange.rate_limit + _RATE_LIMIT_BUFFER_MS,
        ...
        self._symbols: List[str] = list(settings.exchange.supported_symbols)
